//String Matching: Rabin-Karp, Knuth-Morris-Pratt, and Naive Algorithms This experiment implements three string-matching algorithms—Naive, Rabin-Karp, and Knuth-Morris-Pratt (KMP)—to highlight string search efficiency. Comparing these algorithms enables students to appreciate optimized string search techniques in applications like search engines and bioinformatics.
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <time.h>
