//Insertion in Binary Search Tree (BST) This experiment implements both iterative and recursive methods for inserting elements in a Binary Search Tree (BST). 
#include <time.h>
